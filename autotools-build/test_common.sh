...
abs_top_srcdir=/home/runner/work/netcdf-c/netcdf-c/autotools-build/..
abs_top_builddir=/home/runner/work/netcdf-c/netcdf-c/autotools-build
...
FEATURE_ROS3=yes
FEATURE_S3_AWS=no
FEATURE_S3_INTERNAL=no
FEATURE_S3=no
FEATURE_NCZARR=yes
FEATURE_S3TESTS=no
FEATURE_NCZARR_ZIP=no
FEATURE_LARGE_TESTS=no

FEATURE_PLUGIN_INSTALL_DIR=""
FEATURE_PLUGIN_SEARCH_PATH="/usr/local/hdf5/lib/plugin"
...
S3TESTBUCKET=unidata-zarr-test-data

# This is the s3 path within the Unidata bucket;
# All S3 tests should use this to store intermediate results.
S3TESTSUBTREE=netcdf-c
